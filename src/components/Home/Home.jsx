...
const Home = () => {
  ...
  return (
    <div>
      ...
      <div>
        <h1 className="ban1 flex items-center justify-center text-5xl font-bold pt-24">
          I Grow By Helping People In Need
        </h1>
        <div className="sea1 flex justify-center items-center">
        <input className="w-1/4 px-7 py-3.5 rounded-l-lg border-r-0 border-2 border-solid" type="text" placeholder="Search here...."/>
